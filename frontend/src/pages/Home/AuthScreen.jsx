...
const AuthScreen = () => {
  ...
  return (
    <div className="hero-bg relative">
      ...
      {/* 1st section */}
      <div1 className="py-10 bg-black text-white">
        <div12 className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
          {/* left side */}
          ...
          {/* right side */}
          <divr className="flex-1 relative">
